...
<body>
                ...
                <ul class="links">
                    ...
                    <li>
                        ...
                        <ul class="htmlCss-sub-menu sub-menu">
                            ...
                            <li><a href="alurprl.html">Alur Pelayanan</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">Pengaduan</a>
    ...
    <!--Struktur body-->
    <h1>Isi Data</h1>
    <form class="" action="prosesdaftar.php" method="post">
        ...
        <label class="container">Pria
            <input type="radio" checked="checked" name="jeniskelamin">
        ...
        <input type="text" name="telepon" autocomplete="off"> <br>
